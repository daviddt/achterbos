...
$(function() {
	...
	$('.mast-side, .expand').hover(function(){
	...
	$.simpleWeather({
		...
		success: function(weather) {
		  ...
		  html += '<span class="weather_temp">'+weather.tempAlt+'<sup>&deg;C</sup></span>';
		  html += '<span class="weather_type">'+weather.currently+'</span>';

		  

		  $(".mast-side .content").html(html);
		},
		error: function(error) {
		  $(".mast-side .content").html('<p>'+error+'</p>');
		}
	});
